...
/*
    01 - Como você pode melhorar a declaração do array abaixo?
...
/*
    03 - Melhore a estrutura do código abaixo. 
...
/*
    04 - Declare uma const banda e atribua a ela um objeto vazio.
*/
...
/*
    05 - A partir daqui, todo código relacionado ao objeto banda que 
...
console.log(`Nome da banda: ${banda.nome}`);


/*
    06 - Adicione no objeto banda uma propriedade generos.
...
/*
    07 - Adicione no objeto banda uma propriedade estaNaAtiva.
...
console.log(`A banda está na ativa? ${banda.estaNaAtiva}`);


/*
    08 - Adicione no objeto banda uma propriedade albuns.
...
console.log('Albuns da banda:', banda.albuns);


/*
    09 - Abaixo deste comentário, modifique o valor da propriedade ano 
...
/*
    10 - Acesse o primeiro caractere do valor da propriedade url que está 
